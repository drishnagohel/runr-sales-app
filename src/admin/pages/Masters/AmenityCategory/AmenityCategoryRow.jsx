...
import { updateAmenityCategory, deleteAmenityCategory } from "../../../../api";
import { getDateTab, Textcapitalize, getNameAvtarSingle } from "../../../../utils";


export default function ProjectRow({ project, refreshDate }) {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const result = await updateAmenityCategory(data);
  ...
  try {
    const result = await deleteAmenityCategory({ guid: project.guid });
  ...
  return (
    <>
      <tr className="project-row">
        <td className="project-id">{project.amenitie_category_id}</td>
        <td>                                        
            <span class="tag tag-primary">{project.amenitie_category_name}</span>
        </td>                                     
        <td>
