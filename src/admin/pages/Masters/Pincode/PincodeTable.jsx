...
import ProjectRow from "../Pincode/PincodeRow";
import MasterLayout from "../../../components/layout/MasterLayout";
import Pagination from "../../../components/Pagination";
import { getAllPincode } from "../../../../api";
...
export default function PincodeTable() {
  ...
  const fetchPincode = async () => {
    ...
    try {
      ...
      const result = await getAllPincode(offset, itemsPerPage, search);
  ...
  // --- Fixed Search Filter ---
const filteredPincode = Pincode.filter((p) =>
...
const currentPincode = filteredPincode; // ✅ now maps filtered results
        ...
        <div className="px-5 py-4">
          <div className="is-flex is-gap-4 is-align-items-center is-justify-content-space-between">
            <div className="card-title">
              <h1 className="fs-5 fw-600 lh-1">Pincode</h1>
              <ul className="breadcrumbs mt-1">
                <li>
                  <a href="/masters">Masters</a>
                </li>
                <li className="active">Pincode</li>
              </ul>
            </div>
              ...
              {loading ? (
                ...
                <div className="text-nowrap theme-scrollbar-horizontal">
                  <table className="theme-table">
                    ...
                    <tbody>
                      {currentPincode.map((p) => (
                        <ProjectRow
                          key={p.id || p.project_id}
                          project={p}
                          refreshPincode={fetchPincode}
